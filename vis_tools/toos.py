...
def _set_axes_radius(ax, origin, radius):
    # Source:
    #   https://github.com/qcr/benchbot_api/blob/abe11acf8cd274058bc785f603c016b41ec3eefd/benchbot_api/tools.py#L76
...
def _set_axes_equal(ax):
    # Source:
    #   https://github.com/qcr/benchbot_api/blob/abe11acf8cd274058bc785f603c016b41ec3eefd/benchbot_api/tools.py#L82
    limits = np.array([
        ax.get_xlim3d(),
        ax.get_ylim3d(),
        ax.get_zlim3d(),
...
def _vis_bbox3d(ax, bbox3d, facecolor, edgecolor, label):
...
def _vis_semantic_map3d(ax, scene_objects, class_to_color_map, edgecolor):
    for obj in scene_objects:
        label = obj['class']
        facecolor = class_to_color_map[label]
        bbox3d = get_bbox3d(obj['extent'], obj['centroid'])

        _vis_bbox3d(ax, bbox3d, facecolor, edgecolor, label)
